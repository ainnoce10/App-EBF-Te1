...
-- employees: ajout photoUrl si manquant
create table if not exists public.employees ( id text primary key, name text, role text, site text, status text, "entryDate" date, "photoUrl" text, created_at timestamp with time zone default now() );
do $$ 
begin 
