...
-- 3. TABLES DE DONNÉES (Création si inexistante)
...
create table if not exists public.employees ( id text primary key, name text, role text, site text, status text, "entryDate" date, created_at timestamp with time zone default now() );
